...
public class HardOption extends Game{
    private String[] dollarAmount = {"$100","$200","$300","$500","$1,000","$2,000","$4,000","$8,000","$16,000",
                             "$32,000","$64,000","$125,000","$250,000","$500,000","$1,000,000"};

    public HardOption() {
    }

    public HardOption(Player player, QuestionBank questions, Lifeline lifeline, String charPlayerAns) {
    ...
    public void start() {    
        ...
        while(questionNumber < 15) {
            ...
            //int playerAnswer = (int)(Character.toUpperCase(this.charPlayerAns)-65);
